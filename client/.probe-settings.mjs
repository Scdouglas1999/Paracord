...
await page.waitForFunction(() => location.pathname.startsWith('/app'), { timeout: 15000 }).catch(async () => {
  await page.screenshot({ path: `${OUT}/login-fail.png` });
...
// Open user settings via the gear in the user panel
