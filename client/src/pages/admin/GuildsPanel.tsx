          ...
          <table className="w-full min-w-[680px] text-left">
            <thead>
              <tr className="border-b border-border-subtle bg-bg-tertiary/40">
                <th scope="col" className="px-5 py-3 text-section text-text-secondary">Guild</th>
                <th scope="col" className="px-5 py-3 text-section text-text-secondary">Description</th>
