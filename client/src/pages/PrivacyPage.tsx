...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Operational logs, including IP addresses and device information tied to sign-ins, are retained for a limited period to protect the instance against abuse and to help diagnose problems.',
    ],
  },
  {
    id: 'how-data-is-used',
    ...
    body: [
      ...
      'Instance operators can access operational logs and moderation data strictly for abuse prevention, safety, and keeping the deployment running.',
    ],
  },
  {
    id: 'federation',
  ...
  },
  {
    ...
    body: [
      ...
      'End-to-end encryption protects the contents of supported conversations so that not even the instance operator can read them. Metadata required to route messages is still processed.',
    ],
  },
  {
    ...
    body: [
      'You may request deletion of your account and associated data from the instance operator. Once processed, your profile and messages are removed according to this deployment’s retention schedule.',
