...
describe('MobileBottomNav', () => {
  it('opens the first joined server Channels home when no server was explicitly selected', () => {
    renderNav();
  ...
  it('always returns to Rooms for the selected server, not an arbitrary last channel', () => {
