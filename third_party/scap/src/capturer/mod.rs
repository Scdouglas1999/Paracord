...
impl Capturer {
    ...
    /// Try to get the next available captured frame without blocking.
    pub fn try_get_next_frame(&self) -> Result<Option<Frame>, mpsc::TryRecvError> {
        loop {
