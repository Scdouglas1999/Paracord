...
// Auto-generated D-Bus interface kept complete; not every method is exercised.
#[allow(dead_code)]
...
// {
// Auto-generated D-Bus interface kept complete; the `close` method is unused here.
#[allow(dead_code)]
...
// The parsed vardict is retained for debugging/inspection though only the node id is read.
#[derive(Debug)]
#[allow(dead_code)]
